...
contract SupplyChain is ConsumerRole, DistributorRole, FarmerRole, RetailerRole, Ownable  {
  ...
  onlyFarmer()
  {
    ...
    items[_upc].distributorID = 0x0000000000000000000000000000000000000000;
    items[_upc].retailerID = 0x0000000000000000000000000000000000000000;
    items[_upc].consumerID = payable(0x0000000000000000000000000000000000000000);
    // Increment sku
    sku = sku + 1;
